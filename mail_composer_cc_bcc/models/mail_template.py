...
class MailTemplate(models.Model):
    ...
    def _generate_template_recipients(  # noqa:C901
        self, res_ids, render_fields, allow_suggested=False, find_or_create_partners=False, render_results=None
    ):
        self.ensure_one()
    ...
    def _generate_template(self, res_ids, render_fields,recipients_allow_suggested=False, find_or_create_partners=False):
